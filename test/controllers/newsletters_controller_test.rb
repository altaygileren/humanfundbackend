...
class NewslettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post newsletters_url, params: { newsletter: { newsemail: @newsletter.newsemail } }, as: :json
    end
  ...
  test "should update newsletter" do
    patch newsletter_url(@newsletter), params: { newsletter: { newsemail: @newsletter.newsemail } }, as: :json
    assert_response 200
  end
